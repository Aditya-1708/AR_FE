...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const phoneNumber = "919611103554"; // no +, no spaces
      ...
      <section className="relative py-24 md:py-32 flex flex-col items-center justify-center text-white text-center px-6 overflow-hidden bg-[#393185]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto leading-relaxed font-light">
            Have a project in mind? We'd love to discuss how our manufacturing
            ...
            <div className="bg-slate-50 p-8 md:p-14 lg:p-16 border-t lg:border-t-0 lg:border-l border-slate-200 flex flex-col h-full">
              ...
              <div className="space-y-6 mb-10 flex-grow">
                ...
                <div className="rounded-2xl overflow-hidden shadow-md ring-1 ring-slate-200 bg-white relative group h-80">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62031.02425350812!2d77.46725597689199!3d13.661472150414799!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bb1bdead0a6c35f%3A0xeef9cbfbd819da4d!2sA%20R%20INDUSTRIES!5e0!3m2!1sen!2sin!4v1770958177175!5m2!1sen!2sin"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen=""
                ...
                <div className="grid gap-4">
                  ...
                  >
                    <div className="w-12 h-12 rounded-full bg-green-50 flex items-center justify-center group-hover:bg-green-500 transition-colors duration-300 shrink-0">
                      <i className="fab fa-whatsapp text-2xl text-green-600 group-hover:text-white"></i>
                    </div>
                    <div>
                      <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-0.5">
                        WhatsApp
                      </p>
                      <p className="text-base font-bold text-slate-900 group-hover:text-green-600 transition-colors font-mono">
                        +91-9611103554
                      </p>
                    </div>
                  </a>
                  ...
                  <a
                    ...
                    className="flex items-center gap-5 p-4 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-md hover:border-red-500 hover:scale-[1.01] transition-all duration-300 group"
                  >
                    <div className="w-12 h-12 rounded-full bg-red-50 flex items-center justify-center group-hover:bg-red-500 transition-colors duration-300 shrink-0">
                      <i className="fas fa-envelope text-2xl text-red-600 group-hover:text-white"></i>
                    </div>
                    <div>
                      <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-0.5">
                        Email
                      </p>
                      <p className="text-base font-bold text-slate-900 group-hover:text-red-600 transition-colors">
